            ...
            <form onSubmit={handleCreateThread} className="grid gap-4">
              <div className="grid gap-4 md:grid-cols-[1fr_220px]">
                <label className="grid gap-2 text-sm font-black">
                  ...
                  <input
                    ...
                    className="h-12 min-w-0 rounded-2xl border border-gray-200 bg-white/90 px-4 text-sm font-semibold outline-none transition focus:border-[#19d3cf] focus:shadow-[0_0_0_4px_rgba(25,211,207,0.14)]"
                    required
                  />
                </label>
                ...
                <label className="grid gap-2 text-sm font-black">
                  ...
                  <select
                    ...
                    className="h-12 min-w-0 rounded-2xl border border-gray-200 bg-white/90 px-4 text-sm font-semibold outline-none focus:border-[#19d3cf]"
                  >
                    {forumCategories.map((category) => (
              ...
              <label className="grid min-w-0 gap-2 text-sm font-black">
                ...
                <textarea
                  ...
                  className="min-w-0 rounded-2xl border border-gray-200 bg-white/90 px-4 py-3 text-sm font-semibold leading-relaxed outline-none focus:border-[#19d3cf] focus:shadow-[0_0_0_4px_rgba(25,211,207,0.14)]"
                  required
                />
              </label>
            ...
            <div className="mb-4 min-w-0 rounded-3xl border border-[#19d3cf]/35 bg-white/90 p-4 shadow-sm backdrop-blur">
              <label className="relative block min-w-0">
                ...
                <input
                  ...
                  className="h-12 w-full max-w-full min-w-0 rounded-2xl border border-gray-200 bg-white/90 px-4 pr-24 text-sm font-bold outline-none transition focus:border-[#19d3cf] focus:shadow-[0_0_0_4px_rgba(25,211,207,0.14)]"
                />
                {search && (
                  <button
                    type="button"
