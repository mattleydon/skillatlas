  ...
  return (
    <main className="relative min-h-screen overflow-x-clip bg-sa-canvas text-sa-text-primary">
      ...
      <div className="skillatlas-page-shell relative z-10 mx-auto w-full max-w-6xl px-4 pb-8 sm:px-6 lg:px-8 lg:pb-10">
        <Link
          href={ROUTES.forum}
          className="mb-sa-3 inline-flex min-h-11 items-center gap-sa-2 rounded-sa-control border border-sa-border-subtle bg-sa-surface-1 px-sa-3 text-sm font-medium text-sa-accent transition-colors duration-200 hover:border-sa-border-active hover:bg-sa-surface-2 focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-sa-accent/20"
        >
        ...
        {discussion ? (
          <>
            <IntelligencePanel
              ...
              header={
                <div>
                  ...
                  <h1
                    id="discussion-title"
                    className="sa-type-page-title mt-sa-2 max-w-5xl break-words text-sa-text-primary"
                  >
                    {discussion.title}
                  </h1>
                  <p className="sa-type-meta mt-sa-3 text-xs leading-5 text-sa-text-technical">
                    Started by <span className="font-medium text-sa-text-primary">{discussion.author}</span>
                    <span aria-hidden="true"> · </span>
                    {discussion.country}
                  </p>
                </div>
            ...
            >
              <div className="max-w-2xl">
                <h3 className="sa-type-heading text-base text-sa-text-primary">No persisted replies are available.</h3>
          ...
          >
            ...
            <h1 id="missing-discussion-title" className="sa-type-page-title mt-sa-2 text-sa-text-primary">
              Discussion unavailable
            </h1>
            <p className="sa-type-intro mx-auto mt-sa-2 max-w-xl text-sa-text-muted">
              This discussion is not part of the current Forum sample set.
            </p>
            <Link
              href={ROUTES.forum}
              className="mt-sa-4 inline-flex min-h-11 items-center rounded-sa-control bg-sa-accent px-sa-4 text-sm font-medium text-slate-950 transition-opacity duration-200 hover:opacity-90 focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-sa-accent/25"
            >
              Browse discussions
            </Link>
          </IntelligencePanel>
