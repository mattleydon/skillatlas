    ...
    <div className="flex flex-col gap-sa-3 lg:flex-row lg:items-end lg:justify-between">
      <div className="min-w-0">
        ...
        <div className="mt-sa-1 flex flex-wrap items-baseline gap-x-sa-3 gap-y-sa-1">
          <h2 id={titleId} className="sa-type-heading text-lg text-sa-text-primary">
            {title}
          </h2>
          {metadata ? <span className="sa-type-meta text-xs text-sa-text-technical">{metadata}</span> : null}
        </div>
      </div>
