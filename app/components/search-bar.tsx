      ...
      <input
        ...
        className={
          intelligence
            ...
            : "h-11 w-full rounded-sa-control border border-[#19d3cf]/35 bg-white/90 px-3 pr-12 text-sm font-normal outline-none transition-all duration-300 placeholder:text-gray-400 focus:border-[#19d3cf] focus:shadow-[0_0_0_4px_rgba(25,211,207,0.14)]"
        }
      />
      <svg
        viewBox="0 0 20 20"
